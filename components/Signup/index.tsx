...
const SIGNUP_MUTATION = gql`
  mutation SIGNUP_MUTATION($UserSignupInput: UserSignupInput) {
...
class Signup extends Component<MultiProps, SignupState> {
    ...
    isBirthDateValid = () => {
      const date = new Date(this.state.birthDate.year, this.state.birthDate.month, this.state.birthDate.day);
                ...
                >
                  <fieldset disabled={loading} aria-busy={loading}>
                    ...
                    <label htmlFor="birthDate">
                      Birth Date
                      <input type="number" onChange={this.handleBirthDateChange} name={general.birthDate.day} value={this.state.birthDate.day}/>
                      <input type="number" onChange={this.handleBirthDateChange} name={general.birthDate.month} value={this.state.birthDate.month}/>
                      <input type="number" onChange={this.handleBirthDateChange} name={general.birthDate.year} value={this.state.birthDate.year}/>
                    </label> 
                    <br />
