...
export interface OfferPriceChartProps extends MultiProps {
  stats: Statistics;
  theme: StyledComponentTheme;
  price: number;
}

class OfferPriceChart extends React.Component<OfferPriceChartProps> {
  chart = null;
  ...
  createChart() {
    const { stats, translations, price } = this.props;
    ...
    chart.data = [
      {
        ...
        value: averagePriceAPI,
        full: upperBound,
      },
      {
        category: translations.stats.appAverage,
        value: averagePriceApp,
        full: upperBound,
      },
      {
        category: translations.stats.offerPrice,
        value: price,
        full: upperBound,
      },
    ];
...
export default multi(withTheme(OfferPriceChart));
