...
const translations: Translations = {
  ...
  carCategory: {
    ...
    Truck: 'Camion',
    Van: 'Camionnette',
    Crossover: 'Véhicule Multi-Segments',
    'Incomplete - Cutaway': 'Incomplete - Plans coupés',
    Bus: 'Autobus',
    Incomplete: 'Incomplet',
    Liftback: 'Liftback',
    'Motorcycle - Street': 'Motocyclette - Rue',
    'Motorcycle - Scooter': 'Motocyclette - Scooter',
    'Motorcycle - Sport': 'Motocyclette - Sport',
    Minivan: 'Mini-Camionnette',
